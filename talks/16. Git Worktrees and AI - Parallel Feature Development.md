...
- The full "How We Build" series: talks/14 (process) → talks/15 (governance) → talks/16 (parallel execution) → **talks/29 (team adoption + learning: Figma MCP, Pencil MCP, NotebookLM)**. If an interviewer asks how the team actually ramps on this toolchain, that's the 29 story
