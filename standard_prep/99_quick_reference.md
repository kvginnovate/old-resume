...
|------|--------|----------|
| Project Narratives (14 stories) | ✅ Complete | `01_project_narratives.md`, `14_gcp_firebase_mcp_poc.md` |
...
| Behavioral STAR Stories (15) | ✅ Complete | `08_leadership_behavioral_qa.md`, `08_star_stories_supplement.md`, `08_incident_story_itma_auth_memory_leak.md`, `08_behavioral_gaps_supplement.md` |
...
| DSA / Coding Problems | ✅ Complete | `12_coding_dsa_prep.md` |
| Low-Level Design / OOD | ✅ Complete | `13_low_level_design_ood.md` |
...
| Step | Time | Action |
|------|------|--------|
| 1 | 2 hrs | **Re-read `01_project_narratives.md`** — All 14 stories. Pick your P0s (Subscriber Platform, Spring Boot 3, Sling TV, AI Agent Skills) |
...
| 6 | 2 hrs | **DSA warmup** — Run through `12_coding_dsa_prep.md`: 3-step framework, 2-3 problems, Big-O review |
| 7 | 1 hr | **LLD practice** — Pick 1-2 problems from `13_low_level_design_ood.md` (Parking Lot, Vending Machine) |
| 8 | 30 min | **SQL review** — Window functions and joins from `14_sql_querying_prep.md` |
...
| 2 | 30 min | **Company research** — Read `00_company_research_standard.md`. Review tech stack, domain, 5 talking points |
| 3 | 15 min | **Read `18_interview_day_plan.md`** — Logistics, tech setup, mental prep protocol |
| 4 | 15 min | **Read `15_questions_to_ask.md`** — Pick your 3 questions for each interviewer type |
| 5 | 15 min | **Read `panic_management.md`** — Emergency mental checklist for nerves |
| 6 | 15 min | **Numbers drill** — Rehearse these numbers cold: 10M subscribers, 60% (Boot 3), 70% (Sling), 5 teams, 85% coverage, 30min→2min |
...
| File | Content | Size |
|------|---------|------|
| `standard_prep/01_project_narratives.md` | 14 project stories at Principal altitude (P0-P2) | ~44KB |
...
| `standard_prep/00_1day_emergency_plan.md` | 1-day crash plan: what to read, what to skip, time blocks, drill schedule | ~6KB |
| `standard_prep/00_interview_communication.md` | Communication guide: 5 rules, answer templates, STAR-F, non-verbal, drills | ~10KB |
...
||| `standard_prep/08_incident_story_itma_auth_memory_leak.md` | Incident story: itma-auth-service memory leak (JMeter, Rancher) | ~7KB |
||| `standard_prep/08_behavioral_gaps_supplement.md` | 6 missing behavioral categories (delegation, mentorship, ambiguity, hiring, cross-team, failure) | ~17KB |
| `standard_prep/12_coding_dsa_prep.md` | DSA prep for Principal coding rounds: 2-week plan, 3-step framework, 10 problems, Big-O cheat sheet, Java tips | ~9KB |
| `standard_prep/13_low_level_design_ood.md` | Low-Level Design / OOD: framework, 5 problems, design patterns, SOLID, class diagrams | ~6KB |
| `standard_prep/14_sql_querying_prep.md` | SQL: joins, window functions, optimization, isolation levels, migration patterns | ~8KB |
| `standard_prep/15_questions_to_ask.md` | 14 questions by interviewer type, must-ask question, topics to avoid | ~5KB |
| `standard_prep/16_compensation_negotiation.md` | Compensation: market range, scripts, negotiation levers, red flags, walk-away numbers | ~6KB |
| `standard_prep/17_java_deep_dive.md` | Java deep dive: JVM memory, GC, concurrency, virtual threads, Spring Boot internals, Java 17+ | ~12KB |
| `standard_prep/18_interview_day_plan.md` | Day plan: week before → day before → morning of → during → between rounds → after | ~10KB |
| `standard_prep/00_company_research_standard.md` | Company research: The Standard overview, IBTE, domain constraints, 5 talking points, questions | ~12KB |
| `standard_prep/14_gcp_firebase_mcp_poc.md` | GCP + Firebase MCP auto-provisioning POC: spec-to-infrastructure, zero-touch, MCP pattern expansion | ~10KB |
...
- [ ] Prepared "Why this company" answer with specific details from `00_company_research_standard.md`
- [ ] Reviewed DSA framework (`12_coding_dsa_prep.md`) and can run through 3-step problem-solving
- [ ] Reviewed 1-2 LLD problems (`13_low_level_design_ood.md`)
- [ ] Reviewed SQL window functions (`14_sql_querying_prep.md`)
- [ ] Picked 3 questions to ask from `15_questions_to_ask.md`
- [ ] Reviewed `18_interview_day_plan.md` for logistics
- [ ] Know compensation range from `16_compensation_negotiation.md`
